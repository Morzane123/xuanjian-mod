...
public class XjCommand<S> {
    ...
    public LiteralArgumentBuilder<S> build() {
        return LiteralArgumentBuilder.literal("xj")
                .then(LiteralArgumentBuilder.literal("help").executes(this::help))
                .then(LiteralArgumentBuilder.literal("version").executes(this::version))
                .then(LiteralArgumentBuilder.literal("bind")
                        .then(RequiredArgumentBuilder.argument("account", StringArgumentType.word())
                                .executes(this::bind))
                        .then(LiteralArgumentBuilder.literal("status").executes(this::bindStatus)))
                .then(LiteralArgumentBuilder.literal("checkin").executes(this::checkin))
                .then(LiteralArgumentBuilder.literal("task")
                        .then(LiteralArgumentBuilder.literal("list").executes(this::taskList))
                        .then(LiteralArgumentBuilder.literal("my").executes(this::taskMy))
                        .then(LiteralArgumentBuilder.literal("accept")
                                .then(RequiredArgumentBuilder.argument("id", IntegerArgumentType.integer(1))
                                        .executes(this::taskAccept)))
                        .then(LiteralArgumentBuilder.literal("verify")
                                .then(RequiredArgumentBuilder.argument("id", IntegerArgumentType.integer(1))
                                        .then(RequiredArgumentBuilder.argument("code", StringArgumentType.word())
                                                .executes(this::taskVerify)))))
                .then(LiteralArgumentBuilder.literal("cb")
                        .executes(this::cbBalance)
                        .then(LiteralArgumentBuilder.literal("pay")
                                .then(RequiredArgumentBuilder.argument("player", StringArgumentType.word())
                                        .then(RequiredArgumentBuilder.argument("amount", IntegerArgumentType.integer(1))
                                                .executes(this::cbPay))))
                        .then(LiteralArgumentBuilder.literal("confirm").executes(this::cbConfirm))
                        .then(LiteralArgumentBuilder.literal("cancel").executes(this::cbCancel)))
                .then(LiteralArgumentBuilder.literal("claim")
                        .then(RequiredArgumentBuilder.argument("amount", IntegerArgumentType.integer(1))
                                .then(RequiredArgumentBuilder.argument("reason", StringArgumentType.greedyString())
                                        .executes(this::claim))))
                .then(LiteralArgumentBuilder.literal("online").executes(this::online));
    }
