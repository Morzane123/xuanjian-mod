 ...
 *
 * <p>Minecraft 26.2 客户端 GUI 约定（与 FabricMC/fabric-docs 的 CustomScreen 参考实现一致）：
 * <ul>
 ...
 *   <li>切换界面在本版本用 {@code Minecraft.gui.setScreen(...)}（26.1 是 {@code Minecraft.setScreen}）。</li>
...
public class XuanjianInfoScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(Button.builder(Component.literal("设置"), b ->
                        this.minecraft.gui.setScreen(new XuanjianConfigScreen(this)))
